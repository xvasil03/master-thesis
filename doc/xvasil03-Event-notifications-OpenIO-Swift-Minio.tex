...
\projectinfo{
  ...
  abstract.en={
    ...
    In order to accomplish this goal, new middleware is proposed that can be run inside a pipeline of Proxy Server in OpenStack Swift and inside pipeline of OIO-Swift inside OpenIO SDS.
