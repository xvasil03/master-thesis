...
\section{Middleware for OpenStack Swift and OpenIO SDS}
    ...
    EventNotification describes published event using CloudEvents specification. For OpenIO SDS application can create events data using event-agent service and have compatible structure with events published directly from event-agent service.
    ...
    \lstset{
        ...
        comment=[l]{:},
        commentstyle=\color{black},
        caption=Data structure of event published by EventNotification middleware.
    }
    ...
    Listing \ref{eventConfiguration} describes event notification configuration. Destination value
