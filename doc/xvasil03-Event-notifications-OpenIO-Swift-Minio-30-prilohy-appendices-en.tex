...
\dirtree{%
.1 /.
.2 thesis ---- thesis documentation.
.2 excel-paper.pdf ---- Article written for EXCEL@FIT2022.
.2 src ---- source codes.
...
.4 demo\_openio ---- OpenIO SDS demo with enabled ENOSS.
...
\textbf{Demo OpenIO SDS} - check \texttt{src/enoss/demo\_openio/README.txt}
